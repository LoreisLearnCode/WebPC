...
const AccountCreate = () => {
    ...
    return (
        <div className="create_account">
            <h1 style={{ borderRadius: 1, marginTop: 40, marginBottom: 0, padding: 15, color: "#FFFFFF", background: "linear-gradient(-135deg,  rgb(251, 0, 255) ,rgb(255, 0, 64))" }}>Tạo tài khoản Admin</h1>
            ...
            >
                <Spin spinning={loading}>
                    ...
                    >
                        ...
                        <Form.Item >
                            <Button style={{ background: "#D70018", color: '#FFFFFF', float: 'right', marginTop: 20, marginLeft: 8 }} htmlType="submit">
                                Hoàn thành
                            </Button>
                            <Button style={{ background: "#D70018", color: '#FFFFFF', float: 'right', marginTop: 20 }} onClick={CancelCreateRecruitment}>
                                Hủy
                            </Button>
                        </Form.Item>
                    </Form>
